...
Tokens are used for authentication of a user in order to proceed to protected routes. If a user doesn't have a token or has an incorrect one, they will be denied access.

- [ ] What steps can you take in your web apps to keep your data secure?

Require tokens, create private routes, make calls that require authentication.

- [ ] Describe how web servers work.

Web servers are either a computer that stores code for a website or a program that runs on a computer. A web server program serves files that form a webpage when a user makes a request via the browser.
